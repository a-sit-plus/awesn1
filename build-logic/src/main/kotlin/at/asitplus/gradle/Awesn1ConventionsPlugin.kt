...
class Awesn1ConventionsExtension(private val project: Project) {
    init {
        val awesn1Version: String by project.extra
        project.version = awesn1Version
            ...
            publications {
                withType<org.gradle.api.publish.maven.MavenPublication> {
                    ...
                    pom {
                        ...
                        url.set("https://github.com/a-sit-plus/awesn1")
                        licenses {
                            license {
                        ...
                        scm {
                            connection.set("scm:git:git@github.com:a-sit-plus/awesn1.git")
                            developerConnection.set("scm:git:git@github.com:a-sit-plus/awesn1.git")
                            url.set("https://github.com/a-sit-plus/awesn1")
                        }
                    }
                }
...
fun Project.awesn1Conventions(init: Awesn1ConventionsExtension.() -> Unit) {
    Awesn1ConventionsExtension(this).init()
}
