...
object Asn1 {
    ...
    /**
     * Safe version of [Sequence], wrapping the result into a [Result]
     */
    fun SequenceSafe(root: Asn1TreeBuilder.() -> Unit) = catchingUnwrapped { Sequence(root) }
    ...
    /**
     * Safe version of [Set], wrapping the result into a [Result]
     */
    ...
    /**
     * Safe version of [SetOf], wrapping the result into a [Result]
     */
    ...
    /**
     * Safe version on [ExplicitlyTagged], wrapping the result into a [Result]
     */
    fun ExplicitlyTaggedSafe(tag: ULong, root: Asn1TreeBuilder.() -> Unit) =
        catchingUnwrapped { ExplicitlyTagged(tag, root) }
 ...
 * */
@Throws(Asn1Exception::class)
fun Float.encodeToAsn1Primitive() =
    Asn1Primitive(Asn1Element.Tag.REAL, Asn1Real(this.toDouble()).encodeToAsn1ContentBytes())
