...
import at.asitplus.awesn1.encoding.Asn1.OctetString
import at.asitplus.awesn1.encoding.Asn1.OctetStringEncapsulating
import at.asitplus.awesn1.encoding.Asn1.PrintableString
import at.asitplus.awesn1.encoding.Asn1.UtcTime
import at.asitplus.awesn1.encoding.Asn1.Utf8String
...
val Asn1EncodingTest by matrixSuite {
    ...
    listOf(true, false).asData(name = "Boolean") test { value ->
    ...
    listOf(
        ...
        ).asData(name = "Manual hex") test { hex ->
        Asn1Element.Companion.parseFromDerHexString(hex).toDerHexString() shouldBe hex.replace(" ", "")
    }
