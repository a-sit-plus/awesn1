...
val EcdsaSigValueTest by matrixSuite {
    "Test" {
        ...
        sigValue.toEcdsaSigValue().let {
            it.r.toDecimalString() shouldBe "75702550467927847687504835259358957068594330833158195591194084637648375100822"
            it.s.toDecimalString() shouldBe "63921562560111841846899158949481573510824775155107323853077162713843342976888"
        }
    }
}
