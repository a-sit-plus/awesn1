...
package at.asitplus.awesn1.crypto.legacy.pki
...
import at.asitplus.awesn1.crypto.legacy.SignatureAlgorithmIdentifier
import at.asitplus.awesn1.crypto.legacy.SubjectPublicKeyInfo
...
open class TbsCertificate(
    ...
    val validFrom: Asn1Time.SecondsCapped,
    val validUntil: Asn1Time.SecondsCapped,
    ...
    companion object : Asn1Serializable<Asn1Sequence, TbsCertificate> {
        ...
        override fun doDecode(src: Asn1Sequence): TbsCertificate = src.decodeRethrowing {
            ...
            TbsCertificate(
                ...
                validFrom = validity.first.secondsCapped(),
                validUntil = validity.second.secondsCapped(),
