    ...
    withData(chain) {
        ...
        attestationCertChain.forEachIndexed { index, certificate ->
            ...
            withClue(index.toString()) {
               val ownDecoded= DER.decodeFromByteArray<at.asitplus.awesn1.crypto.pki.X509Certificate>(certificate.encoded)
                assertEquals(ownDecoded, certificate)
                DER.encodeToByteArray(ownDecoded) shouldBe certificate.encoded
            }
        }
    }
}
