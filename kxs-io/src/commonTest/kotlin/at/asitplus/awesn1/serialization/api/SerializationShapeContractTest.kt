...
val SerializationTestShapeContract by testSuite(
    ...
    "Nullable raw ASN.1 element in the middle is rejected as undecidable" {
        ...
        shouldThrow<SerializationException> {
            DER.decodeFromSource<AmbiguousMiddleNullableRawAsn1>(Buffer().apply { write("3006020101020102".hexToByteArray()) })
        }
    }
    ...
    "Explicitly tagged nullable raw ASN.1 element in the middle is deterministic" {
        ...
        DER.decodeFromSource<DisambiguatedMiddleNullableRawAsn1>(Buffer().apply { write(
            Buffer().apply { DER.encodeToSink(
                withoutExtension
            , this) }.readByteArray()
    ...
    "Trailing nullable raw ASN.1 element remains supported" {
        ...
        DER.decodeFromSource<TrailingNullableRawAsn1>(Buffer().apply { write(
            Buffer().apply { DER.encodeToSink(
                withoutExtension
            , this) }.readByteArray()
        ) }) shouldBe withoutExtension
