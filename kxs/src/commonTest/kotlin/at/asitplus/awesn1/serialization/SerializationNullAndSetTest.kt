...
val SerializationTestNullAndSet by testSuite(
    ...
    "Nulls and Noughts" {
        ...
        derExplicitNulls.decodeFromByteArray<TaggedNullableInt>(
            derExplicitNulls.encodeToByteArray(taggedValue)
        ) shouldBe taggedValue

        val omitted = TaggedNullableIntOmit(value = null)
        DER.decodeFromByteArray<TaggedNullableIntOmit>(
            DER.encodeToByteArray(omitted)
        ) shouldBe omitted
        ...
        DER.decodeFromByteArray<NullablePlainString>(
            DER.encodeToByteArray(emptyString)
        ) shouldBe emptyString

        val nullString = NullablePlainString(null)
        DER.decodeFromByteArray<NullablePlainString>(
            DER.encodeToByteArray(nullString)
        ) shouldBe nullString
    }
}
